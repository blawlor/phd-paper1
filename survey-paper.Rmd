...
The results of our survey confirm that there is a deficit in bio-informatic software engineering, and we turn our attention now to what its causes and remedies might be, beyond what has already been discussed in the reviewed literature. We believe that in order to address this deficit effectively, it is necessary to understand the difference between software development and software engineering, hence the discussion earlier. We assert that it is impractical, if not impossible, to introduce the necessary levels of software engineering expertise into bio-informatics by treating it as a sub-component of bio-informatics. It requires too large a body of knowledge, and it is attained by too different a form of education to simply be bolted on to existing bio-informatic curricula. Put another way, we believe that the most effective way of introducing software engineering values into bio-informatic research is to introduce software engineers themselves.

The earlier discussion on the difference between software engineering and programming underlines what we believe to be the limitations of solutions based in education and methodologies which do not 

While improvements in bio-informatic curricula, as suggested by Umarji et al. [@umarji2009software] would be a positive step, it is not suffi
