...
Two obvious features of complexity are intricacy and unpredicability. Biological processes are undoubtedly *intricate* - they contain many levels and numerous inter-dependent components which in turn lead to intricate domain models in bio-informatic software. Intricacy can be tamed by a 'divide and conquer' approach: identifying and separating the various components of a complex system. In fact, the role of any skilled software engineer is to map this problem domain to a solution domain (a software implementation). Thus tamed, a biolgical problem domain is no more unpredicable than a business one. Most of the subsequent complexity of any project is down to the unpredicable nature of the people and processes working on it, a factor which increases with project size rather than subject nature. 
...
The main obstacle to this solution is hinted at by []. The way in which research projects are funded does not currently take into account the costs associated with developing software. As we have suggested above, the reader can see the problem with this attitude towards software by comparing it to the attention given to hardware. While not every project will be able to budget for a full-time bio-informatic engineer to work esclusively, research groups should be able to share such resources, or make use of specialized external software companies which would grow in number to meet this demand.

## Recommendations

* Explicit recognition of the role of Bio-Informatic Engineer, along with a shared understanding of the compentencies and functions of that role.
