...
result <- data.frame(reproducibleBuildColumn, releaseScriptsColumn, sourceControlBranchingColumn, ciWithUnitTestsColumn, autoSourceAnalysisColumn)
cols <- c("Automated/Reproducible Builds", "Release Scripts", "Source Control Branching", "Continuous Integration with Unit Testing", "Automated Source Code Analysis")
colnames(result) <- cols
