...
The results of our survey confirm that there is a deficit in bio-informatic software engineering skills, and we turn our attention now to what its causes and remedies might be, beyond what has already been discussed in the reviewed literature. We believe that in order to address this deficit effectively, it is necessary to take into account the difference between computer programming and software engineering that we discussed earlier. We assert that it is impractical, if not impossible, to introduce the necessary levels of software engineering expertise into bio-informatics by treating it as a sub-component of bio-informatics. It requires too large a body of knowledge, and it is attained by too different a form of education to simply be bolted on to existing bio-informatic curricula. Put another way, we believe that the most effective way of introducing software engineering values into bio-informatic research is to introduce software engineers themselves.

While improvements in bio-informatic curricula, as suggested by Umarji et al. [@umarji2009software] would be a positive step in that it could lead to improved communication between bio-informaticians and software engineers, it is not sufficient by itself to fill the current gap. The selection of software engineering methodologies that are particularly suitable for bio-informatics projects is worthy, but again it is not enough: Who would steer the use of such techniques in the absence of a skilled and experienced software engineer? Arguments presented in existing literature that are based on special pleading are problematic in two ways. 

<firstly they don't offer much by way of remedies>
<secondly, they are incorrect and in some ways a reversal of the logic>
